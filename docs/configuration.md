...
| `LAZER_API_URL` | `--lazer-api-url` | `https://pyth-lazer.dourolabs.app` | Lazer (Pyth Pro) price API for scan-side proxy price composition. Only used when `LAZER_API_TOKEN` is set. |
